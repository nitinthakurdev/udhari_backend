...
const toPublicSubscription = (subscription: ISubscriptionSchema): ISubscriptionPublic => ({
  ...
  config: {
    allowed_transitions: subscription.config.allowed_transitions,
    allowed_connected_customers: subscription.config.allowed_connected_customers,
    allowed_connected_businesses: subscription.config.allowed_connected_businesses,
    allowed_connected_users: subscription.config.allowed_connected_users,
    allowed_managed_businesses: subscription.config.allowed_managed_businesses,
  },
  ...
  google_play_product_id: subscription.google_play_product_id,
